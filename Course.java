...
public class Course {
    ...
    private ArrayList<Integer> prerequisites = new ArrayList<>();

    //Mark that signifies whether the course is running or not
    ...
    /**
     * Returns whether the course is marked cancelled or not.
     */
...
//            System.out.println("Error: student already in another course.");
        ...
        //If the student doesn't have all the prerequisites then he won't be enrolled.
        else if (!student.hasAllPrerequisites( prerequisites ) ) {
            return false;
        }
...
//            System.out.println("Error: Student has already studied the course");
    ...
    public boolean setInstructor (Instructor instructor) {
        if ( instructor.isFree() && instructor.canTeach(this.subject)) {
    ...
    /**
     * Sets the prerequisites of the course, taking as parameter the prerequisites of the subject that the course is
     * teaching.
     */
